package org.hisrc.xjc.v_2_3.maven.plugin;
...
import org.hisrc.xjc.maven.RawXJC2Mojo;
...
public class XJC23Mojo extends RawXJC2Mojo<Options> {
	...
	private final org.hisrc.xjc.maven.OptionsFactory<Options> optionsFactory = new OptionsFactory();

	@Override
	protected org.hisrc.xjc.maven.OptionsFactory<Options> getOptionsFactory() {
