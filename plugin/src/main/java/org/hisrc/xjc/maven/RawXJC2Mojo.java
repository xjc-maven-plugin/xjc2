...
import org.hisrc.xjc.maven.net.CompositeURILastModifiedResolver;
import org.hisrc.xjc.maven.net.FileURILastModifiedResolver;
import org.hisrc.xjc.maven.net.URILastModifiedResolver;
import org.hisrc.xjc.maven.resolver.tools.MavenCatalogResolver;
import org.hisrc.xjc.maven.resolver.tools.ReResolvingEntityResolverWrapper;
import org.hisrc.xjc.maven.util.ArtifactUtils;
import org.hisrc.xjc.maven.util.CollectionUtils;
import org.hisrc.xjc.maven.util.IOUtils;
import org.hisrc.xjc.maven.util.LocaleUtils;
import org.hisrc.xjc.maven.util.CollectionUtils.Function;
		...
		if (getGrammars().isEmpty()) {
			...
			if (getForceRegenerate()) {
				getLog().warn("You are using forceRegenerate=true in your configuration.\n"
						...
						+ "https://github.com/xjc-maven-plugin/xjc2/wiki/Do-Not-Use-forceRegenerate\n"
